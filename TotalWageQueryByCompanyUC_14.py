...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input == 0:
            ...
            minimum_working_hours = int(input("Enter the Monthly minimum working hours of your company: "))
            minimum_working_days = int(input("Enter the Monthly minimum working days of your company: "))
            per_day_wage = int(input("Enter per hour wage of your company: "))
